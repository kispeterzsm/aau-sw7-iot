...
export default function SearchPanel({
    ...
    const displayProgress = status === 'completed' ? 100 : Math.min(progress, 90);
    return (
            ...
            <form onSubmit={onSearch} className="mt-6 space-y-5">
                <div className="space-y-2">
                    ...
                    <div className="text-xs text-slate-500 flex items-center gap-1.5">
                        <span>💡</span>
                        <span>Longer inputs provide better context for tracking</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <button
                        ...
                        className={`cursor-pointer col-span-3 inline-flex items-center justify-center gap-2 px-4 py-3 text-white font-semibold rounded-xl shadow-lg disabled:cursor-not-allowed transition-all hover:shadow-md 
                            ${isSearching 
                                ? "bg-gradient-to-r from-emerald-500 to-cyan-500/70" // Dimmed when searching
                ...
                <div className="space-y-4 border-t border-slate-200/50 pt-5 dark:border-slate-700/50">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center text-xs text-slate-600 dark:text-slate-400">
                            ...
                            <span className="font-mono font-semibold text-emerald-600">{Math.round(displayProgress)}%</span>
                        </div>
                    </div>
                </div>
            </form>
