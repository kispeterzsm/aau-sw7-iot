            ...
            {status === "loading" ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-slate-200/50 hover:border-slate-300/50 hover:bg-slate-100/50 transition-all backdrop-blur-sm font-medium dark:text-slate-300 dark:hover:text-slate-100 dark:border-slate-700/50 dark:hover:bg-slate-900/50"
                >
                  <div className="w-8 h-8 cursor-pointer rounded-full bg-gradient-to-r from-emerald-500 to-cyan-500 flex items-center justify-center text-white font-semibold text-sm">
                    {getUserInitial()}
                  </div>
                </button>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-48 rounded-lg border border-slate-200/50 bg-white/90 backdrop-blur-lg shadow-lg z-50 dark:bg-slate-900/90 dark:border-slate-700/50">
                    <div className="p-2">
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2 cursor-pointer text-sm text-red-600 hover:bg-red-50 rounded-md transition-colors dark:text-red-400 dark:hover:bg-red-900/50"
                      >
                        Sign out
                      </button>
                    </div>
